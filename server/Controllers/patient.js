...
exports.dischargePatient = async(req, res)=>{
  ...
  try {
    ...
    const updatePatient = await Patient.findOneAndUpdate({_id: id},{isDischarged : true}, {new: true});

    if(updatePatient){
      return res.status(200).json({ message: "Patient Action Updated succesfully" });
    }
